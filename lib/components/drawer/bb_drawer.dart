...
class BBDrawer extends StatelessWidget {
  const BBDrawer({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Drawer(
      ...
      const DrawerHeader(
          ...
          child: Text("Menu")),
      DrawerButton(
          AppLocalizations.of(context)!.m_history, TripHistoryPage.routeName),
      DrawerButton(AppLocalizations.of(context)!.m_user, UserPage.routeName),
      DrawerButton(
          AppLocalizations.of(context)!.m_settings, SettingsPage.routeName)
    ]));
  }
}
