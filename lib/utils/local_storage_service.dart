...
class LocalStorageService {
  ...
  static Future<bool> writeBool(String key, bool value) => instance.setBool(key, value);

  static String? readString(String key) => instance.getString(key);

  static Future<bool> writeString(String key, String value) => instance.setString(key, value);

  static int? readInt(String key) => instance.getInt(key);

  static Future<bool> writeInt(String key, int value) => instance.setInt(key, value);
}
